...
- (IBAction)accentSegHandler:(id)sender {
    ...
    if (control.selectedSegmentIndex == 1) {//普通话
    ...
    }else if (control.selectedSegmentIndex == 2) {//英语
        [IATConfig sharedInstance].language = [IFlySpeechConstant LANGUAGE_ENGLISH];
        [IATConfig sharedInstance].accent = @"";
        
    }else if (control.selectedSegmentIndex == 0) {//粤语
        
        [IATConfig sharedInstance].language = [IFlySpeechConstant LANGUAGE_CHINESE];
        [IATConfig sharedInstance].accent = [IFlySpeechConstant ACCENT_CANTONESE];
        
    }else if (control.selectedSegmentIndex == 3) {//四川话
        
        [IATConfig sharedInstance].language = [IFlySpeechConstant LANGUAGE_CHINESE];
        [IATConfig sharedInstance].accent = [IFlySpeechConstant ACCENT_SICHUANESE];
